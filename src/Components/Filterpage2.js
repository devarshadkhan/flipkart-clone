              ...
              <div className="bag-31 shadow">
                <div class="wrapper center-block hidden-xs">
                  <div class="filters-text">
                    ...
                    <input
                      class="filter-span"
                      placeholder="find product using filters below"
                      type="text"
                    ></input>
                  ...
                  <div class="text-right refine">
                    {" "}
                    <button
                      class="btn btn-out btn-primary btn-square"
                      id="button-filter"
                    >
                      Refine Search
                    </button>
                    ...
                    <ul class="list-group shadow">
                      <li class="list-group-item">
                        <div class="media align-items-lg-center flex-column flex-lg-row">
                          ...
                          <img
                            src={
                              "https://res.cloudinary.com/dxfq3iotg/image/upload/v1571750338/Ecommerce/Laptop-3.jpg"
                            }
                            alt=""
                            width="250"
                            height="200"
                          ...
                          <div class="media-body order-2 order-lg-2 ml-lg-5">
                            <h5 class="mt-0 mb-1">
                              Acer acreanon laptop with 16GB RAM/ 500GB HDD
                            </h5>
                            <div class="product-rating mb-2">
                              {" "}
                              <span class="badge23">
                                <i class="fa fa-star"></i> 4 Star
                              </span>{" "}
                              <span class="rating-review mb-1">
                                4 Ratings &amp; 3 Recommendations
                              </span>{" "}
                            </div>{" "}
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-1">
                              <ul class="list-inline small">
                                <li>
                                  <img
                                    src={
                                      "https://img.icons8.com/material-outlined/10/000000/filled-circle--v1.png"
                                    }
                                    alt=""
                                  />{" "}
                                ...
                                <li>
                                  <img
                                    ...
                                    alt=""
                                  />{" "}
                                  4GB RAM with Radeon 530 2GB Graphics
                                </li>
                              </ul>
                              <ul class="list-inline small">
                                <li>
                                  <img
                                    ...
                                    alt=""
                                  />{" "}
                                  EMI Starts at 1726. No cost EMI available
                                </li>
                                <li>
                                  <img
                                    src={
                                ...
                                <li>
                                  <img
                                    ...
                                    alt=""
                                  />{" "}
                                  In Stock: 24 units sold this week
                                </li>
                              </ul>
                            </div>
                            <Link
                              className="custom-btn btn-3 bag-32"
                              to="/buynow"
                            >
                              <span>Add Cart</span>
                            </Link>
                      ...
                      <li class="list-group-item">
                        <div class="media align-items-lg-center flex-column flex-lg-row">
                          ...
                          <img
                            src={
                              "https://res.cloudinary.com/dxfq3iotg/image/upload/v1571750391/Ecommerce/hp-17-x061nr-white-background.jpg"
                            }
                            alt=""
                            height="200"
                            width="250"
                          ...
                          <div class="media-body order-2 order-lg-2 ml-lg-5">
                            <h5 class="mt-0 mb-1">
                              HP Celeron laptop with 8GB RAM/ 250GB HDD
                            </h5>
                            <div class="product-rating mb-2">
                              {" "}
                              <span class="badge23">
                                <i class="fa fa-star"></i> 5 Star
                              </span>{" "}
                              <span class="rating-review mb-1">
                                4 Ratings &amp; 6 Recommendations
                              </span>{" "}
                            </div>{" "}
                            <span class="product_price price-new">
                              ₹ 25,186{" "}
                      ...
                      <li class="list-group-item">
                        <div class="media align-items-lg-center flex-column flex-lg-row">
                          ...
                          <div class="media-body order-2 order-lg-2 ml-lg-5">
                            <h5 class="mt-0 mb-1">
                              Acer Modifier laptop with 12GB RAM/ 500GB HDD
                            </h5>
                            <div class="product-rating mb-2">
                              {" "}
                              <span class="badge23">
                      ...
                      <li class="list-group-item">
                        <div class="media align-items-lg-center flex-column flex-lg-row">
                          ...
                          <div class="media-body order-2 order-lg-2 ml-lg-5">
                            <h5 class="mt-0 mb-1">
                              ASUS Modifier Gaming laptop with 12GB RAM/ 500GB
                              HDD
                            </h5>
                            <div class="product-rating mb-2">
                              {" "}
                      ...
                      <li class="list-group-item">
                        <div class="media align-items-lg-center flex-column flex-lg-row">
                          ...
                          <img
                            src={
                              "https://res.cloudinary.com/dxfq3iotg/image/upload/v1571751108/Ecommerce/laptop-dell-xps-15-computer-monitors-laptops.jpg"
                            }
                            alt=""
                            width="250"
                            height="200"
                          ...
                          <div class="media-body order-2 order-lg-2 ml-lg-5">
                            <h5 class="mt-0 mb-1">
                              XPS Gaming laptop with 12GB RAM/ 500GB HDD /
                              Graphics Card
                            </h5>
                            <div class="product-rating mb-2">
                              {" "}
