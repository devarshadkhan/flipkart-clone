  ...
  <div id="Checkout" class="inline">
      ...
      <form>
          ...
          <div class="form-group">
              ...
              <input id="NameOnCard" class="form-control null" type="text" maxlength="255"></input>
          </div>
          <div class="form-group">
          ...
          <div class="security-code-group form-group">
              ...
              <div class="input-container" >
                  ...
                  <i id="cvc" class="fa fa-question-circle bag-50"></i>
              </div>
          ...
          <div class="zip-code-group form-group">
              ...
              <div class="input-container">
                  ...
                  <Link to="" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal code for your credit card billing address."><i class="fa fa-question-circle bag-50"></i></Link>
              </div>
          </div>
