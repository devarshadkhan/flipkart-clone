...
;(function($){
	$.fn.picZoomer = function(options){
		var opts = $.extend({}, $.fn.picZoomer.defaults, options), 
			$this = this,
			$picBD = $('<div class="picZoomer-pic-wp"></div>').css({}).appendTo($this),
      ...
      <div class="row row-sm">
         <div class="col-md-6 _boxzoom">
            <div class="zoom-thumb">
               <ul class="piclist">
                  <li><img src={img48} alt=""/></li>
                  <li><img src={img49} alt=""/></li>
                  <li><img src={img50} alt=""/></li>
                  <li><img src={img51} alt=""/></li>
                  <li><img src={img52} alt="" /></li>
               </ul>
            </div>
               ...
               <div class="_p-price-box">
                  ...
                  <div class="_p-add-cart">
                     <div class="_p-qty">
                        ...
                        <div class="value-button decrease_" id="decrease_" value="Decrease Value">-</div>
                        <input type="number" name="qty" id="number" value="1" />
                        <div class="value-button increase_" id="increase_" value="Increase Value">+</div>
                     </div>
                  </div>
                  <div class="_p-features">
                     <span> Available offers</span>
                        <ul>
                        <li><i class="fa-solid fa-tag"></i>Special PriceGet extra 10% off (price inclusive of discount)</li>
                        <li><i class="fa-solid fa-tag"></i>Partner OfferSign up for Flipkart Pay Later and get Flipkart Gift Card worth ₹100*</li>
                        <li><i class="fa-solid fa-tag"></i>PPartner OfferEarn 10% up to 100 Super Coins on every purchase of Select Men’s Clothing products</li>
                        <li><i class="fa-solid fa-tag"></i>Combo OfferBuy 2 items save 5%;Buy 3 or more save 10%</li>
                        </ul>
                  </div>
                  ...
                  <p className="bag-46">Delivery by29 May, Sunday |<span>Free₹40</span></p>
                  ...
                  <Link to="" data-bs-toggle="popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">5.0 <i className="fa fa-star"></i></Link>
                  <div className="img53">
                  <img src={img53} alt="" />
                  </div>
                  </div>
